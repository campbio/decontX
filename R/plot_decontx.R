...
#' @param x Either a \linkS4class[SingleCellExperiment]{SingleCellExperiment}
#' with \code{decontX}
...
#' @param x Either a \linkS4class[SingleCellExperiment]{SingleCellExperiment} or
...
#' plot if \code{x} is a
#' \linkS4class[SingleCellExperiment]{SingleCellExperiment}. If more than one
#' assay is listed, then side-by-side barplots will be generated.
...
#' \linkS4class[SingleCellExperiment]{SingleCellExperiment}. See
#' \code{\link{retrieveFeatureIndex}}
...
#' plot if \code{x} is a
#' \linkS4class[SingleCellExperiment]{SingleCellExperiment}. If more than one
#' assay is listed, then side-by-side violin plots will be generated.
#' Default \code{c("counts", "decontXcounts")}.
